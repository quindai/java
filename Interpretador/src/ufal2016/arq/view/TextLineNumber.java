	...
	implements CaretListener, DocumentListener, PropertyChangeListener
{
	...
	public TextLineNumber(JTextComponent component, int minimumDisplayDigits)
	{
		...
		setFont(new Font("calibri", Font.BOLD, 11));
		//setBorderGap(2);
	...
	//try select line from code\-UNDER CONSTRUCTION
	public void selectLine(int i) throws BadLocationException{
		//int caretPosition = component.getCaretPosition();
		//Element root = component.getDocument().getDefaultRootElement();
		component.setCaretPosition(i);
		//Rectangle clip = this.getBounds();
		
		//System.out.println(root.getElementIndex(caretPosition));
